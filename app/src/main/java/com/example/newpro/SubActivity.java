...
public class SubActivity extends AppCompatActivity { //이 클래스 이름이 SubActivity
    ...
    boolean check_allday=false;
    String alarmallday="0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get 방식2
        String serverUrl1 = "http://15.164.218.79:8080/test_table/getreturn.jsp";

        //String getUrl = serverUrl + "?title1=" + title1 + "&place1=" + place1 + "&content1=" + content1  ;
        String getUrl1 = serverUrl1;

        StringRequest stringRequest1 = new StringRequest(Request.Method.GET, getUrl1, new Response.Listener<String>() {
            @Override
            public void onResponse(String response1) {
                //while문으로 line해서 읽어오는 작업과 UI에 업데이트하는 runOnUiThread도 안만들어도 된다.
                String[] arr1 = response1.split("/");
                System.out.println("arr1[1]:"+arr1[1].charAt(1));
                char num = arr1[1].charAt(1);
                if(num =='1')
...
//Get 방식
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        {
            ...
            //  alarmtime_end= mTxtTime1.getText().toString();
            alarmdate = mTxtDate.getText().toString();

            if(check_allday==true)
            {
                alarmtime="000000";
                // alarmtime_end="000000";
            }
    ...
    public void clickPost(View view) {
        ...
        {
            time2 = mTxtTime1.getText().toString();
            time1 = mTxtTime.getText().toString();
        }
        ...
        final String return_allday = alarmallday;

        // String allday = null;//check_allday;
/*
        if(check_allday==true)
        {
            allday="1";
...
*/
        ...
        StringRequest stringRequest= new StringRequest(Request.Method.POST, serverUrl, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                datas.put("check_allday",return_allday);
